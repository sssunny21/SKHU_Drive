...
public class DriveController {
	...
	@RequestMapping("/pdrive/test.pd")
	public @ResponseBody List<Drive> list() {
		System.out.println("test");
		return driveMapper.selectFolderAll();
	}
	...
	/**
	 * @RequestMapping("/pdrive/fileDelete.pd") public String
	 * delete(@RequestParam("id") int id) { driveMapper.delete(id); return
	 * "redirect:/pdrive/main.pd"; }
	 * 
	 * @RequestMapping("/pdrive/fileDownload.pd") public void
	 * download(@RequestParam("fd_id") int fd_id, HttpServletResponse response)
	 * throws IOException { List<Drive> drive = driveMapper.selectById(fd_id);
	 ...
	 * BufferedOutputStream(response.getOutputStream())) { output.write(((Drive)
	 * drive).getData()); } }
	 **/
