		...
		<nav>
			<ul class="nav nav-pills pull-right">
				<li><button type="button" class="btn" data-toggle="modal"
						data-target=".bs-example-modal-sm">폴더생성</button></li>
			...
			<table class="table table-striped">
									...
									<td>
										<div class="checkbox"
											...
											<label><input type="checkbox" name="folder_id"
												value="${dr1.folder_id}"></label>
										</div>
									</td>
									<td><img src="/drive/res/images/folder-2-256.png"
										style="width: 22px; height: 18px;" /> ${dr1.folder_name}</td>
									<td>미정</td>
									<td id="edit" class="btn btn-primary" role="presintation"
										onload="editFdPopup()" onclick="editFdPopup(${dr1.folder_id})">폴더수정</td>
				...
				<tbody>
					<c:forEach var="dr2" items="${dr2}">
						...
						<tr data-toggle="modal2" data-target=".bs-example-modal-sm"
							data-url2="sfolderList2.pd?fd_id=${dr2.sfolder_id }&dr_id=${dr2.drive_id}">
							<td>
								<div class="checkbox"
									style="margin-top: 0px; margin-bottom: 0px;">
									<label><input type="checkbox"></label>
							...
							<td><img src="/drive/res/images/cloud-key-lock-256.png"
								style="width: 22px; height: 18px;" /> ${dr2.sfolder_name}</td>
							<td data-url="#">미정</td>
							<td id="edit" class="btn btn-primary" role="presintation"
								onload="editSFdPopup()"
								onclick="editSFdPopup(${dr2.sfolder_id})">폴더수정</td>
						</tr>
					</c:forEach>
				</tbody>
			</table>
