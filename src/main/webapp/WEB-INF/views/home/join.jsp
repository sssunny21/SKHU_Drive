...
<style>
    ...
    <form:form method="post" modelAttribute="user">
		...
		<br>
        	...
        	<input type="radio" name="u_grade" id="1" value="1"/>1
        	</label><label class="radio-inline">
        	<input type="radio" name="u_grade" id="2" value="2"/>2
        	</label><label class="radio-inline">
        	<input type="radio" name="u_grade" id="3" value="3"/>3
        	</label><label class="radio-inline">
        	<input type="radio" name="u_grade" id="4" value="4"/>4
        	</label>
		<br>
